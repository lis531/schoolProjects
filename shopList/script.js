...
const createButton = () => {
    ...
    button.innerHTML = `<svg fill="red" viewBox="0 0 448 512" height="15px" width="15px" xmlns="http://www.w3.org/2000/svg" style="rotate: 45deg;"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"></path></svg>`
    return button;
}
...
for(let i = 0; i < buttons.length; i++){
    buttons[i].addEventListener("click", () => removeItem(buttons[i].parentElement));
}
